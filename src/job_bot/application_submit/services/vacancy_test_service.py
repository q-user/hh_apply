"""Vacancy test service — fetch, prepare answers, build payload, submit.

.. versionchanged:: 2.0
   Moved from ``hh_applicant_tool.services.vacancy_tests`` to
   ``job_bot.application_submit.services.vacancy_test_service``
...
from hh_applicant_tool.utils.datatypes import VacancyTest, VacancyTestsData
from hh_applicant_tool.utils.string import rand_text, strip_tags

if TYPE_CHECKING:
    import requests

    from hh_applicant_tool.application.ports import DelayPort, HttpClientPort
