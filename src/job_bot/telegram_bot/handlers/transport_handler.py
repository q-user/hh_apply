...
The handler is intentionally minimal: it pulls updates from the transport
in a loop, hands each one to ``on_update`` and advances the offset. On
transport errors it backs off and continues.
"""
...
# Back-off parameters (defaults match the existing CLI operation).
...
class TransportHandler:
    """Long-polling loop over a :class:`TelegramTransportPort`."""
